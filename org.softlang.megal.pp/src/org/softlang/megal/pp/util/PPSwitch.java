...
public class PPSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PPPackage.PACKAGE: {
				org.softlang.megal.pp.Package package_ = (org.softlang.megal.pp.Package)theEObject;
	 ...
	 * @generated
	 */
	public T casePackage(org.softlang.megal.pp.Package object) {
		return null;
	}
