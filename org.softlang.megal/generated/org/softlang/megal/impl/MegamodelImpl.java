 ...
 * <em><b>Megamodel</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.softlang.megal.impl.MegamodelImpl#getDeclarations <em>
 * Declarations</em>}</li>
 * <li>{@link org.softlang.megal.impl.MegamodelImpl#getBindings <em>Bindings
 * </em>}</li>
 * <li>{@link org.softlang.megal.impl.MegamodelImpl#getName <em>Name</em>}</li>
 * <li>{@link org.softlang.megal.impl.MegamodelImpl#getImports <em>Imports</em>}
 * </li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MegamodelImpl extends MinimalEObjectImpl.Container implements
		Megamodel {
	/**
	...
	public EList<Declaration> getDeclarations() {
		if (declarations == null) {
			declarations = new EObjectContainmentEList<Declaration>(
					...
					MegalPackage.MEGAMODEL__DECLARATIONS);
		}
		return declarations;
	}
	...
	public EList<Link> getBindings() {
		if (bindings == null) {
			bindings = new EObjectContainmentEList<Link>(Link.class, this,
					MegalPackage.MEGAMODEL__BINDINGS);
		}
		return bindings;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MegalPackage.MEGAMODEL__NAME, oldName, name));
	}
	...
	public EList<Megamodel> getImports() {
		if (imports == null) {
			imports = new EObjectResolvingEList<Megamodel>(Megamodel.class,
					this, MegalPackage.MEGAMODEL__IMPORTS);
		}
		return imports;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		switch (operationID) {
		case MegalPackage.MEGAMODEL___GET_VISIBLE_DECLARATIONS:
